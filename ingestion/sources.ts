/**
 * Declarative registry of news feeds to crawl. Analogous in spirit to
 * GraphOne's config/sources.yaml, but listing NEWS PUBLISHERS' real RSS
 * feeds rather than company blog paths to guess at.
 *
